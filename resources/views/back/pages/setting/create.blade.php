...
@section('title', 'Tərcümə əlavə et')

@section('breadcrumb')
    @include('back.includes.breadcrumb', [
        'items' => ['Tərcümələr', 'Tərcümə əlavə et'],
        'page_title' => 'Tərcümə əlavə et',
    ])
@endsection
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <input type="text" name="key" id="key" oninput="convert_letter(this)"
                                value="{{ old('key') }}" class="form-control">
                            @error('key')
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="value_{{ $lang }}"
                                            value="{{ old('value_' . $lang) }}" id="value_{{ $lang }}"
                                            class="form-control">
                                        @error('value_' . $lang)
                                            <div class="invalid-feedback" style="display: block;">
                                                {{ $message }}
