...
<nav class="sidebar dark_sidebar vertical-scroll  ps-container ps-theme-default ps-active-y">
    <div class="logo d-flex justify-content-between">
        <a href="index-2.html"><img src="{{ asset('back/assets')}}/img/logo_white.png" alt=""></a>
    ...
    <ul id="sidebar_menu">
        <li class="mm-active">
            <a class="has-arrow" href="#" aria-expanded="false">
                <!-- <i class="fas fa-th"></i> -->
                <div class="icon_menu">
                    <img src="{{ asset('back/assets')}}/img/menu-icon/dashboard.svg" alt="">
                </div>
                <span>Dashboard</span>
            </a>
            <ul>
        ...
        <li class="">
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{ asset('back/assets')}}/img/menu-icon/2.svg" alt="">
                </div>
                <span>App</span>
            </a>
            <ul>
        ...
        <li class="">
            <a class="has-arrow" href="#" aria-expanded="false">
                ...
                <div class="icon_menu">
                    <img src="{{ asset('back/assets')}}/img/menu-icon/3.svg" alt="">
                </div>
                <span>UI Kits</span>
            </a>
            <ul>
        ...
        <li class="">
            <a class="has-arrow" href="#" aria-expanded="false">
                ...
                <div class="icon_menu">
                    <img src="{{ asset('back/assets')}}/img/menu-icon/4.svg" alt="">
                </div>
                <span>forms</span>
            </a>
            <ul>
        ...
        <li class="">
            <a class="has-arrow" href="#" aria-expanded="false">
                ...
                <div class="icon_menu">
                    <img src="{{ asset('back/assets')}}/img/menu-icon/5.svg" alt="">
                </div>
                <span>Icons</span>
            </a>
            <ul>
        ...
        <li class="">
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{ asset('back/assets')}}/img/menu-icon/6.svg" alt="">
                </div>
        ...
        <li class="">
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{ asset('back/assets')}}/img/menu-icon/7.svg" alt="">
                </div>
        ...
        <li class="">
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{ asset('back/assets')}}/img/menu-icon/8.svg" alt="">
                </div>
                <span>Table</span>
            </a>
            <ul>
        ...
        <li class="">
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{ asset('back/assets')}}/img/menu-icon/9.svg" alt="">
                </div>
                <span>Cards</span>
            </a>
            <ul>
        ...
        <li class="">
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{ asset('back/assets')}}/img/menu-icon/11.svg" alt="">
                </div>
                <span>Charts</span>
            </a>
            <ul>
        ...
        <li class="">
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{ asset('back/assets')}}/img/menu-icon/cubes.svg" alt="">
                </div>
                <span>Widgets</span>
            </a>
            <ul>
        ...
        <li class="">
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{ asset('back/assets')}}/img/menu-icon/map.svg" alt="">
                </div>
                <span>Maps</span>
            </a>
            <ul>
        ...
        <li class="">
            <a class="has-arrow" href="#" aria-expanded="false">
                ...
                <div class="icon_menu">
                    <img src="{{ asset('back/assets')}}/img/menu-icon/10.svg" alt="">
                </div>
                <span>Pages</span>
            </a>
            <ul>
