...
<div class="CHAT_MESSAGE_POPUPBOX">
    <div class="CHAT_POPUP_HEADER">
        ...
        <div class="Chat_Listed_member">
            <ul>
                <li>
                    <a href="{{ asset('back/assets') }}/#">
                        <div class="member_thumb">
                            <img src="{{ asset('back/assets')}}/img/staf/1.png" alt="">
                        </div>
                    </a>
                </li>
                <li>
                    <a href="{{ asset('back/assets') }}/#">
                        <div class="member_thumb">
                            <img src="{{ asset('back/assets')}}/img/staf/2.png" alt="">
                        </div>
                    </a>
                </li>
                <li>
                    <a href="{{ asset('back/assets') }}/#">
                        <div class="member_thumb">
                            <img src="{{ asset('back/assets')}}/img/staf/3.png" alt="">
                        </div>
                    </a>
                </li>
                <li>
                    <a href="{{ asset('back/assets') }}/#">
                        <div class="member_thumb">
                            <img src="{{ asset('back/assets')}}/img/staf/4.png" alt="">
                        </div>
                    </a>
                </li>
                <li>
                    <a href="{{ asset('back/assets') }}/#">
                        <div class="member_thumb">
                            <img src="{{ asset('back/assets')}}/img/staf/5.png" alt="">
                        </div>
                    </a>
                </li>
                <li>
